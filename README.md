...
Before running application these variables need to be defined.
- ISSUER_PROJECT_ID
- BASE_BUCKET_NAME
...
You can then execute your native executable with: `./target/document-service-1.0.0-SNAPSHOT-runner`
